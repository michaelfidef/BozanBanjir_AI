...
def prediksiBanjir(Katulampa, flushingAncol, manggarai, istiqlal, jembatanMerah):
    ...
    # Maka dapat dipastikan Sungai Ciliwung akan banjir
...
with open("BozanBanjir_AI\data.json", "r") as data:
    data = json.load(data)
    for i in range(len(data)):
        if i == 0:
            ...
            print("-" * 90)
            print("Ketinggian Sungai Sebelumnya  : %-10s | %-10s | %-10s | %-10s | %-10s |" % (KatulampaAwal, FlushingAncolAwal, ManggaraiAwal, IstiqlalAwal, JembatanMerahAwal))
            ...
            print("-" * 90)
            print("Ketinggian Sungai Saat Ini    : %-10s | %-10s | %-10s | %-10s | %-10s |" % (KatulampaSekarang, FlushingAncolSekarang, ManggaraiSekarang, IstiqlalSekarang, JembatanMerahSekarang))
            ...
            print("-" * 90)
            print("Prediksi Ketinggian Sungai    : %-10s | %-10s | %-10s | %-10s | %-10s |" % (prediksiKatulampa, prediksiFlushingAncol, prediksiManggarai, prediksiIstiqlal, prediksiJembatanMerah))
